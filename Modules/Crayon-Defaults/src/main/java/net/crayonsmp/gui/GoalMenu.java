...
public class GoalMenu {
    ...
    public static void openGoalMenu(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(player, 54, "§rGoal Menu");
    ...
    public static void setDefaultModelData(Inventory inv){
        ...
        for (int i = 0; i < 3; i++) {
            inv.setItem(i, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rGoodGoal").setCustomModelData(1000).build());
        }

        for (int i = 3; i < 6; i++) {
            inv.setItem(i, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rNeutralGoal").setCustomModelData(1000).build());
        }

        for (int i = 6; i < 9; i++) {
            inv.setItem(i, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rBadGoal").setCustomModelData(1000).build());
        }
        ...
        inv.setItem(0, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rGoodGoal").setCustomModelData(1001).build());
        inv.setItem(3, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rNeutralGoal").setCustomModelData(1002).build());
        inv.setItem(6, new ItemBuilder().setMeterial(Material.IRON_NUGGET).setTitle("§rBadGoal").setCustomModelData(1003).build());
    }
}